...
""" INITIALIZATION """
def initialize_random(layer_dims):
    """
        Arguments:
...
def linear_activation_backward(dA, cache, activation):
    ...
    if activation == "relu":
        dZ = calculate_relu_derivative(dA, activation_cache)
        dA_prev, dW, db = linear_backward_propagation(dZ, linear_cache)

    elif activation == "sigmoid":
        dZ = calculate_sigmoid_derivative(dA, activation_cache)
        dA_prev, dW, db = linear_backward_propagation(dZ, linear_cache)

    return dA_prev, dW, db

def calculate_relu_derivative(dA, cache):
    """
